# Django settings for RandomPages project.
...
PROJECT_DIR, PROJECT_MODULE_NAME = os.path.split(
    os.path.dirname(os.path.realpath(RandomPages.__file__))
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'devlabst4',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '&l3voyj1ui+bu65qvltrjd94iz%w9@(q-6s1y(g11b3%^)yqh)'
...
ROOT_URLCONF = 'RandomPages.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'RandomPages.wsgi.application'
